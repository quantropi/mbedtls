...
} tls_id_group_name_table[] =
{
    ...
    {MBEDTLS_SSL_OQS_TLS_GROUP_MLKEM512 , "mlkem512", 1},
    {MBEDTLS_SSL_OQS_TLS_GROUP_MLKEM768 , "mlkem768", 1},
    {MBEDTLS_SSL_OQS_TLS_GROUP_MLKEM1024, "mlkem1024", 1},
    {MBEDTLS_SSL_QP_TLS_GROUP_QHPPKKEM1 , "qhppkkem1", 1},
    {MBEDTLS_SSL_QP_TLS_GROUP_QHPPKKEM3 , "qhppkkem3", 1},
    {MBEDTLS_SSL_QP_TLS_GROUP_QHPPKKEM5 , "qhppkkem5", 1},
#endif
